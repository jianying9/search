 ...
 */
@ServiceConfig(
        actionName = ActionNames.GET_INFO_TEXT,
...
response = true,
description = "抓取第三方渠道用户信息文本服务")
public class GetInfoTextServiceImpl implements Service {
    ...
    public void execute(MessageContext messageContext) {
        ...
        String text = this.sourceLocalService.getInfoText(sourceEnum, sourceId);
        if (text.length() > 0) {
            ...
            this.spiderDataLocalService.insertInfoData(insertMap);

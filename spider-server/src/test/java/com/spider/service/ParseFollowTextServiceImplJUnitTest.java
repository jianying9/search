 ...
 * @author aladdin
 */
public class ParseFollowTextServiceImplJUnitTest extends AbstractSpiderTest {

    public ParseFollowTextServiceImplJUnitTest() {
    }
    ...
    public void test() {
        ...
        String result = this.testHandler.execute(ActionNames.PARSE_FOLLOW_TEXT, parameterMap);

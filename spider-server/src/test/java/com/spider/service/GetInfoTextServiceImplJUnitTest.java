 ...
 * @author aladdin
 */
public class GetInfoTextServiceImplJUnitTest extends AbstractSpiderTest {

    public GetInfoTextServiceImplJUnitTest() {
    }
